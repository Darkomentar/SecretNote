...
class register1 : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.findViewById<Button>(R.id.RegButton3).setOnClickListener{
            var t =  view.findViewById<EditText>(R.id.editTextEmail).text.toString();
            VM_REGg.email.value = t;
            view.findNavController().navigate(R.id.action_register1_to_register2)
        }
        return view
    }
